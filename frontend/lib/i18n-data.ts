...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "form.error.birthDate": "Use YYYY-MM-DD between 1900-2100.",
    "form.error.birthTime": "Use HH:MM in 24h format (e.g., 07:45)",
    "form.error.birthPlace": "Add city and country (e.g., Jaipur, Bharat)",
    "form.error.lunarTithi": "Lunar tithi must be 1-30.",
    "form.error.moonElement": "Use water, fire, air, earth, or ether for moon element.",
  ...
  hi: {
    ...
    "form.error.birthDate": "YYYY-MM-DD (1900-2100) प्रारूप अपनाएँ।",
    "form.error.birthTime": "24 घंटे HH:MM समय लिखें (जैसे 07:45)",
    "form.error.birthPlace": "शहर और देश जोड़ें (उदा., जयपुर, भारत)",
    "form.error.lunarTithi": "चंद्र तिथि 1-30 के बीच दें।",
    "form.error.moonElement": "तत्व में जल, अग्नि, वायु, पृथ्वी या आकाश लिखें।",
