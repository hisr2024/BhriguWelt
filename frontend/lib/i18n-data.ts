...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "form.error.birthDate": "Invalid birth date. Use YYYY-MM-DD between 1900-2100; tap the calendar if unsure.",
  ...
  hi: {
    ...
    "form.error.birthDate": "अमान्य जन्म तिथि। YYYY-MM-DD (1900-2100) प्रारूप अपनाएँ; संदेह हो तो कैलेंडर बटन दबाएँ।",
  ...
  es: {
    ...
    "nav.future": "Futuro",
    "nav.coreWisdom": "Sabiduría central",
    ...
    "form.error.birthDate": "Fecha de nacimiento inválida. Usa AAAA-MM-DD entre 1900-2100.",
