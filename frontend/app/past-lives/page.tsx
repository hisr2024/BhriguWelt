...
import { Moon, History, Heart, Star, ArrowLeft, Loader2 } from 'lucide-react';
  ...
  const loadData = async () => {
    ...
    try {
      ...
      try {
        ...
        setData({
          offline: true,
          past_life_analysis: 'Your past lives reveal patterns of leadership and service. You have carried wisdom from ancient civilizations.',
          karmic_patterns: [
            'Tendency to take on too much responsibility',
            'Deep connection with healing arts',
            'Strong affinity for teaching and guiding others',
            'Past challenges with authority figures'
          ],
          past_relationships: 'You have karmic connections with several souls in this lifetime, particularly those who challenge you to grow.',
          talents_carried_forward: [
      ...
      console.error('Error loading past lives:', error);
      setError('Failed to load past lives');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-white text-xl">Accessing past life records...</div>
        </div>
      </div>
    );
  }
      ...
      <div className="genz-container py-8 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="genz-title">Past Lives 🌙</h1>
          </div>
          <p className="text-xl text-white/80">
            Explore your previous incarnations and karmic patterns
          </p>
        </motion.div>
