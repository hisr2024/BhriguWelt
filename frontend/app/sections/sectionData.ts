...
export const journeyTimeline = [
  ...
  {
    title: "November recalibration",
    window: "November 2025",
    houseAnchor: "11th house",
    detail: "Reconnect with allies and shared goals through group rituals and steady check-ins.",
    planet: "♄",
    progress: 54,
    progressLabel: "Focus",
    houseIndex: 11,
  ...
  {
    title: "Dezember alignment",
    window: "Dezember 2025",
